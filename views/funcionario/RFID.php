...
<body>
    <div class="d-flex" style="height: 100vh;">
        <!-- Sidebar -->
        <div class="sidebar bg-light p-3" style="width: 280px; height: 100vh; overflow-y: auto;">
            <a href="/" class="d-flex mb-3">
                <img src="../../public/images/logo-fixed.webp" alt="TechFit" style="max-width: 150px;">
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a href="/funcionario/register/treino" class="nav-link link-dark">Montar Treinos</a></li>
                <li><a href="/funcionario/treinos" class="nav-link link-dark">Ver Treinos Disponíveis</a></li>
                <li><a href="/funcionario/RFID" class="nav-link active text-white" style="background-color: #e35c38;">Acesso Academia</a></li>
            </ul>
            <hr>
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center link-dark dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="https://placehold.co/32x32" class="rounded-circle me-2" alt="User">
                    <strong>User</strong>
                </a>
            </div>
        </div>
