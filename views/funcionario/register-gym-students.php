    ...
    <div class="d-flex" style="height:100vh;">
        ...
        <div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-light" style="height: 100vh; width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="/funcionario/register/estudantes" class="nav-link active text-white" style="background-color: #e35c38;" aria-current="page">Cadastrar Alunos</a>
                </li>
                <li>
                    <a href="/funcionario/register/classes" class="nav-link link-dark">Cadastrar Aulas</a>
                </li>
                <li>
                        ...
                        <form method='POST'>
                            ...
                            <div class='row g-3'>
                                ...
                                <div class='col-md-3'>
                                    ...
                                    <select class='form-select' name='PL_ID' required>
                                        <option value=''>Selecione...</option>
                                        <?php echo $controller->buscarPlanos($row['PL_ID']); ?>
                                    </select>
                                </div>
