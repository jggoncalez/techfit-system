    <footer class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-black text-decoration-none" style="height: 86.59px; width:1532px;">
        ...
        <ul class="nav col-md-5 justify-content-end list-unstyled d-flex">
            <li class="ms-3 "><img src="images\black-instagram-logo-3497.svg" alt="insta" style="height: 24px; width:24px;"></li>
            <li class="ms-3 "><img src="images\facebook_icon.svg" alt="face" style="height: 24px; width:24px;"></li>
            <li class="ms-3 "><img src="images\linkedin-2166.svg" alt="linkedin" style="height: 24px; width:24px;"></li>
        </ul></div>
    </footer>
